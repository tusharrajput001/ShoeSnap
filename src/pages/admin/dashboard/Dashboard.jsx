        ...
        <div className="container px-5 mx-auto mb-10">
          <div className="flex flex-wrap -m-4 text-center">
            <div className="p-4 md:w-1/3 sm:w-1/3 w-full">
              <div
                className=" border-2 hover:shadow-gray-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] bg-gray-100 border-gray-300    px-4 py-3 rounded-xl"
                style={{
              ...
              >
                <div
                  className="text-black-500 w-12 h-12 mb-3 inline-block"
                  viewBox="0 0 24 24"
                >
                  <FaBox size={50} />
                </div>
